...
goStraight(-70,5000);
//while(1);
//Rotate(turningAngle(-750,robot.getTheta()),6000);   //转少一点避免卡在墙壁
//goStraight(-40,6000);

Rotate(turningAngle(350-gyroerror,robot.getTheta()),5000);
goStraight(20,5000);
//turn(30, 2000);
//goStraight(5, 2000);

// double t=Brain.timer(vex::timeUnits::msec);
// while(Brain.timer(timeUnits::msec)-t<3000){
//   LeftIntake.spin(vex::directionType::fwd,10000,vex::voltageUnits::mV);
//   RightIntake.spin(vex::directionType::fwd,10000,vex::voltageUnits::mV);
//   LeftUpIntake.spin(vex::directionType::rev,5000,vex::voltageUnits::mV);
//   RightUpIntake.spin(vex::directionType::rev,5000,vex::voltageUnits::mV);
...
//LeftIntakeClamp.spin(vex::directionType::rev,10000,vex::voltageUnits::mV);
RightIntakeClamp.spin(vex::directionType::rev,13000,vex::voltageUnits::mV);
//Rotate(, double speed)

//出得分区 
goStraight(-3,4000);
LeftIntakeClamp.stop(vex::brakeType::hold);
RightIntakeClamp.stop(vex::brakeType::hold);
